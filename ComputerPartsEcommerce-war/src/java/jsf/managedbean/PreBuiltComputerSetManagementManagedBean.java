...
//        }
    ...
    public void subjectSelectionChanged(final AjaxBehaviorEvent event) {
        System.out.println("-----------------------model " + models.get(0).getPreBuiltComputerSetTier().name());
        System.out.println("-----------------------CPU " + models.get(0).getCpu());
        
        System.out.println("------------------------id " + selectedId.toString());
    }

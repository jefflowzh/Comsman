...
//    @Override
//    public List<PreBuiltComputerSetModel> retrievePreBuiltComputerSetModels(Boolean budget, Boolean regular, Boolean premium) {
//        if (budget) {
//            Query query = em.createQuery("SELECT p FROM PreBuiltComputerSetModel p WHERE p.preBuiltComputerSetTier = :tier");
//            query.setParameter("tier", "PREMIUM");
//        } else if ()
//        
//        try {
//            PreBuiltComputerSetModel preBuiltComputerSetModel = (PreBuiltComputerSetModel) query.getSingleResult();
//        
//        
//        
//        
